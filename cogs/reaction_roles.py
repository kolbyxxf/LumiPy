...
class ReactionRoles(commands.Cog):
    ...
    async def cog_load(self):
        # Load reaction roles asynchronously when the cog loads
        self.reaction_roles = await storage.load_reaction_roles()
    ...
    async def reactionrole(
        ...
        await storage.set_reaction_role(
            message_key, 
    ...
    async def removereactionrole(
        ...
        await storage.remove_reaction_role(message_id, emoji)
    ...
    async def clearreactionroles(self, interaction: discord.Interaction, message_id: str):
        ...
        # Clear all reaction roles for this message from database
        await storage.clear_reaction_roles(message_id)
        
        self.reaction_roles.pop(message_id, None)
        await interaction.response.send_message(
